...
- **pandas**, **numpy**, **seaborn**, **joblib**, **scikit-learn**, **matplotlib**, **xgboost** (or `sklearn.ensemble.GradientBoostingRegressor`)  
- Install essentials with:
  ```bash
  pip install pandas numpy seaborn joblib scikit-learn matplotlib xgboost
## 🚀 Usage Workflow
